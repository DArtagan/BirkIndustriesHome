...
our version has been changed a little but that page is a good spot to go
to understand what all the code means in this template.  Also you should consider
using the intense debate plugin on top of this.
*/
?>
