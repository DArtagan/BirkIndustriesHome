...
<div id="content" class="archive-template" role="main">
	...
	<section <?php post_class() ?> id="post-<?php the_ID(); ?>">
		...
		<?php if (have_posts()) : ?>
			...
			<h1 class="page-title"><em>Archive for</em> &#8216;<?php single_cat_title(); ?>&#8217;</h1>
			<?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
			<h1 class="page-title"><em>Posts Tagged</em> &#8216;<?php single_tag_title(); ?>&#8217;</h1>
			<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
			<h1 class="page-title"><em>Archive for</em> <?php the_time('F jS, Y'); ?></h1>
			<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
			<h1 class="page-title"><em>Archive for</em> <?php the_time('F, Y'); ?></h1>
			<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
			<h1 class="page-title"><em>Archive for</em> <?php the_time('Y'); ?></h1>
