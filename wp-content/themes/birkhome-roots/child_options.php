...
<tr>
    <td width="20%" rowspan="2" valign="middle"><strong><?php echo $value['name']; ?></strong></td>
    <td width="80%"><textarea name="<?php echo $value['id']; ?>" type="<?php echo $value['type']; ?>" cols="<?php echo $ta_options['cols']; ?>" rows="<?php echo $ta_options['rows']; ?>"><?php if ( get_settings( esc_textarea($value['id']) ) != "") { echo get_settings( esc_textarea($value['id']) ); } else { echo esc_textarea($value['std']); } ?></textarea></td>
